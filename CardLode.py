...
# su.screen.blit(bild_2, (start_x + sc.card_2["x"], start_y + sc.card2-["y"]))
# su.screen.blit(bild_1, (start_x + sc.card_1["x"], start_y + sc.card1-["y"]))
# su.screen.blit(bild0, (start_x + sc.card0["x"], start_y + sc.card0["y"]))
su.screen.blit(bild1, (start_x + sc.card1["x"], start_y + sc.card1["y"]))
su.screen.blit(bild2, (start_x + sc.card2["x"], start_y + sc.card2["y"]))
su.screen.blit(bild3, (start_x + sc.card3["x"], start_y + sc.card3["y"]))
su.screen.blit(bild4, (start_x + sc.card4["x"], start_y + sc.card4["y"]))
su.screen.blit(bild5, (start_x + sc.card5["x"], start_y + sc.card5["y"]))
su.screen.blit(bild6, (start_x + sc.card6["x"], start_y + sc.card6["y"]))
su.screen.blit(bild7, (start_x + sc.card7["x"], start_y + sc.card7["y"]))
su.screen.blit(bild8, (start_x + sc.card8["x"], start_y + sc.card8["y"]))
su.screen.blit(bild9, (start_x + sc.card9["x"], start_y + sc.card9["y"]))
su.screen.blit(bild10, (start_x + sc.card10["x"], start_y + sc.card10["y"]))
